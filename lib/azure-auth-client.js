...
var _adal = __webpack_require__(86);

var _adal2 = _interopRequireDefault(_adal);

var _dummy = __webpack_require__(124);
...
var _adal = __webpack_require__(103);
...
function buildAdalContext(config) {
  ...
  setInterval(function () {
    return getToken(authContext, _this.authContext.config.clientId);
  }, 60000);
  return authContext;
}
    ...
    value: function build(config) {
      ...
      if (config.useDummyAuthenticationContext) {
        ...
        if (!config.extraQueryParameter) {
          ...
          if (config.domain) config.extraQueryParameter = 'nux=1&domain_hint=' + config.domain;else config.extraQueryParameter = 'nux=1';
        }
...
var base64_url_decode = __webpack_require__(122);
...
var atob = __webpack_require__(123);
